...
24/7 deep multi-model bug-hunting automation for **JTL-Software AG** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, ERP systems (JTL-Wawi), shop platforms (JTL-Shop), POS systems (JTL-POS), APIs, cloud services, customer portals, websites, and domains operated by JTL-Software AG
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/jtl.md` and
...
Program description: German software company providing e-commerce ERP, shop systems, and multichannel retail solutions
